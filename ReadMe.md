...
> `FROM_CHANNEL` - Channel ID(s) split by space or just one channel ID.   Example: ['-1001234567890','-1001234567891']
> `TO_CHANNEL` - Channel ID(s) split by space or just one channel ID.     Example: ['-1001234567893','-1001234567894']
> 
